...
const MobileSegmentDrawer = ({
  ...
  return (
    <div
      className={`z-40 absolute bottom-0 shadow-[0px_0px_20px_10px_#00000024] bg-white ease-in-out duration-300 items-center md:hidden rounded-t-3xl text-center ${
    ...
    >
      ...
      <div className="absolute w-full bg-white h-[17rem] mt-[-1px]">
        <div className="h-full p-5 pb-8 overflow-auto bg-white">
          <Button
            size="md"
